...
// sizes are not important, since we are updating it right after
const renderTarget = new THREE.WebGLRenderTarget(800, 600, {
  // only be used with webgl2, will be ignored if not supported
  // we don't need AA if the device has high pixel ratio. it already has more pixels
...
const DisplacementPass = {
  // the object is just a template, so we put value = null here
  uniforms: {
    tDiffuse: { value: null },
