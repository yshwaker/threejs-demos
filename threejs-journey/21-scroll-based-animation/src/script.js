...
window.addEventListener('scroll', () => {
  ...
  // trigger a rotation when entering into a new section
...
const tick = () => {
  ...
  const intensity = 0.5
  const parallaxX = -cursor.x * intensity
  const parallaxY = cursor.y * intensity
  // easing: only move 1/10 of the distance left at each frame
  // change the camera group so that it is independent of the parallax effect
